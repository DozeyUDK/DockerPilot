"""Compatibility gate for ContainerManager modularization."""
...
SOURCE = ROOT / "src" / "dockerpilot" / "container_manager.py"
BASELINE = ROOT / "tests" / "fixtures" / "container_manager_phase0_api.json"
...
def _current_contract():
    ...
    cls = next(
        ...
        if isinstance(node, ast.ClassDef) and node.name == "ContainerManager"
    )
    methods = {}
